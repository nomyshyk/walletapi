...
public class WalletDao {
    ...
    private static final Map<Integer, Wallet> WalletMap =
            new HashMap<Integer, Wallet>();
    ...
    private static void initWals() {
        ...
        Wallet c1 = new Wallet(1, "Наличные деньги",
                UserDao.getUser(1), true, LocalDateTime.now());
        Wallet c2 = new Wallet(2, "Кредитная карта",
                UserDao.getUser(1), true, LocalDateTime.now());
        Wallet c3 = new Wallet(3, "Мобильный кошелек",
                UserDao.getUser(1), true, LocalDateTime.now());
